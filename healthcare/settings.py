...
database setup, authentication settings, and installed apps.
"""
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME' : timedelta(hours=12),   # Access token validity period
    'REFRESH_TOKEN_LIFETIME' : timedelta(days=1),   # Refresh token validity period
    'AUTH_HEADER_TYPES': ('Bearer',),       # Prefix for authentication header
    'ROTATE_REFRESH_TOKENS': True,  # Generate new refresh token and blacklist old one
